    ...
    <div className="privacy-page">
      ...
      <header className="privacy-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <a href="#/" className="privacy-back-btn" aria-label="Back to Homepage">
            <FiArrowLeft /> <span>Home</span>
          </a>
          <a href="#/" className="privacy-logo" aria-label="Chill Tech Home">
            <div style={{
            ...
            <span className="privacy-logo-name" style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.02rem', color: 'var(--text)' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexShrink: 0 }}>
          <button
            onClick={toggleTheme}
            className="btn btn-ghost privacy-theme-btn"
            aria-label="Toggle theme"
            style={{ padding: '8px 12px', color: theme === 'dark' ? '#f59e0b' : '#3b82f6' }}
          >
            {theme === 'dark' ? <FiSun /> : <FiMoon />}
          </button>
          <a href="#/work-with-me" className="btn btn-primary privacy-cta-btn" style={{ padding: '8px 18px', fontSize: '0.82rem' }}>
      ...
      <style>{`
        ...
        .privacy-logo { display: flex; align-items: center; gap: 10px; flex-shrink: 0; text-decoration: none; }
        .privacy-hero { padding-top: 0; }

        @media (max-width: 768px) {
          .privacy-header { padding: 10px 14px; gap: 8px; }
          .privacy-logo-name { display: none; }
          .privacy-back-btn { padding: 6px 12px; font-size: 0.78rem; }
          .privacy-cta-btn { padding: 7px 12px !important; font-size: 0.78rem !important; }
          .privacy-theme-btn { padding: 7px 10px !important; }
        }
        @media (max-width: 480px) {
          .privacy-header { padding: 8px 10px; gap: 6px; }
          .privacy-back-btn { padding: 5px 10px; font-size: 0.75rem; }
          .privacy-cta-btn { padding: 6px 10px !important; font-size: 0.74rem !important; }
        }
      `}</style>
    </div>
  );
